<form class="form-validate-upd-jquery modifier-appro-content">
    ...
    <div class="form-group">
        ...
        <input type="date" class="form-control input-xs obligatoire" placeholder="Date d'approvisionnement..." name="date_appro_upd" id="date_appro_upd" value="<?= $data->date_appro; ?>" onblur="isFormatDateValideEn(this)" <?= $disabled; ?>>
