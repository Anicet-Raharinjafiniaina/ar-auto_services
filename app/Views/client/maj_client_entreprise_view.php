<form class="form-validate-upd-jquery modifier-user-content">
    ...
    <div class="form-group text-center">
        <span><b><?= "E" . str_pad($data->id, 4, '0', STR_PAD_LEFT); ?></b></span>
    </div>
    ...
    <div class="form-group">
        <label>NIF</label>
        <input type="text" class="form-control input-xs" placeholder="NIF" name="nif_upd"
    ...
    <div class="form-group">
        <label>STAT</label>
        <input type="text" class="form-control input-xs" placeholder="STAT" name="stat_upd"
