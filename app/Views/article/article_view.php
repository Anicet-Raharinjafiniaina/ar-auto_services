                        ...
                        if (!empty($arr_article)):
                            foreach ($arr_article as $key => $value) : ?>
                                <tr id="<?= $value->id ?>" class="text-center">
                                    <td><img src="data:image/png;base64,<?= $value->photo ?>" alt="" width="30" height="30" style="object-fit: cover; border-radius: 8px;"></td>
...
<div id="modal_view_article" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-center" id="title">Modification d'un article</h5>
                <button type="button" class="btn-close float-right" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
